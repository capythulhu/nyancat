...
#define ERR_GET_BIT_NON_EXISTENT    "Attempt to access the value of a non-allocated register."
#define ERR_SET_QUBIT_NON_EXISTENT  "Attempt to set the value of a non-allocated quantum register."
#define ERR_SET_BIT_NON_EXISTENT    "Attempt to set the value of a non-allocated register."
